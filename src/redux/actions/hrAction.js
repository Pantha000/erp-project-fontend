...
export const getEmployee = (keyword) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(
      `${url}/api/v1/get/manager?keyword=${keyword}`,
      { withCredentials: true }
    );
...
export const getSingleEmployee = (id) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(`${url}/api/v1/manager/${id}`, {
      withCredentials: true,
    });
...
export const deleteEmployee = (id) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.delete(`${url}/api/v1/manager/delete/${id}`, {
      withCredentials: true,
    });
...
export const getClient = (keyword) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(
      `${url}/api/v1/get/client?keyword=${keyword}`,
      { withCredentials: true }
    );
...
export const getSingleClient = (id) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(`${url}/api/v1/client/${id}`, {
      withCredentials: true,
    });
...
export const deleteClient = (id) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.delete(`${url}/api/v1/client/delete/${id}`, {
      withCredentials: true,
    });
...
export const getProjectManager = () => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(`${url}/api/v1/project/manager`, {
      withCredentials: true,
    });
...
export const getProjectClient = () => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(`${url}/api/v1/project/client`, {
      withCredentials: true,
    });
...
export const getProject = (keyword) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(
      `${url}/api/v1/get/project?keyword=${keyword}`,
      { withCredentials: true }
    );
...
export const getSingleProject = (id) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(`${url}/api/v1/get/project/${id}`, {
      withCredentials: true,
    });
...
export const getAdminNotification = () => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(`${url}/api/v1/admin/notification`, {
      withCredentials: true,
    });
...
export const getManagerNotification = () => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(`${url}/api/v1/maneger/notification`, {
      withCredentials: true,
    });
...
export const getClientNotification = () => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(`${url}/api/v1/get/client/notification`, {
      withCredentials: true,
    });
...
export const getAttendence = () => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(`${url}/api/v1/get/attendence`, {
      withCredentials: true,
    });
